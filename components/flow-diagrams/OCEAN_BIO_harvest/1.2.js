...
const Flow = () => {
  return (
    <Grid height={26}>
      ...
      <Rectangle start={[29, 7]} id='deepwater-storage-solid' />
      <Arrow start={[32, 12]} length={2} down />
      <Rectangle id='deepwater-storage-dissolved' start={[29, 15]} />
      <Arrow start={[32, 20]} length={2} down />
      <Rectangle id='deepwater-outgass' start={[29, 23]} />
