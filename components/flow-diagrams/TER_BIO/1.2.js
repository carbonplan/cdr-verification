...
const Flow = () => {
  return (
    <Grid height={33}>
      ...
      <Rectangle start={[15, 8]} label='Biomass processing' />
      <Arrow start={[22, 10]} length={2} right />
      <Rectangle id='bio-sink' start={[25, 8]} />
      ...
      <Arrow start={[28, 13]} length={2} down />
      <Rectangle id='deepwater-storage-solid' start={[25, 16]} />
      <Arrow start={[28, 21]} length={1} down />
      <Rectangle id='deepwater-storage-dissolved' start={[25, 23]} />
      <Arrow start={[28, 28]} length={1} down />
      <Rectangle id='deepwater-outgass' start={[25, 30]} />

      <Rectangle id='nsad' start={[25, 3]} height={1} borderStyle='none' />
